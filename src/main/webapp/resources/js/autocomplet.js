let autocomplete = (function () {
    ...
    let inputEvent = function (e) {
        ...
        for (i = 0; i < _arr.length; i++) {
            ...
            if (_arr[i].NAME.substr(0, val.length).toUpperCase() == val.toUpperCase()) {
                b = document.createElement("DIV");
                // value의 값 만큼 굵게 표시 
                b.innerHTML = "<strong>" + _arr[i].NAME.substr(0, val.length) + "</strong>";
                b.innerHTML += _arr[i].NAME.substr(val.length);
                b.innerHTML += "<input type='hidden' value='" + _arr[i].NAME + "'>";
                b.innerHTML += "<input type='hidden' value='" + _arr[i].CODE + "'>";
                ...
                b.addEventListener("click", function (e) {
                    ...
                    document.getElementById('code').value = this.getElementsByTagName("input")[1].value;
                    closeAllLists();
                });
