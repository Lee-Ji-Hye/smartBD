...
<body>
<div class="container space-2" style="width:800px; margin:0 auto" >
	<div class="card-deck d-block d-lg-flex card-lg-gutters-3" style="width:910px;">
          <!-- Stats -->
          <div class="card mb-7 mb-lg-0">
            <div class="card-body pt-4 pb-7 px-7 mb-3 mb-md-0" style="width:900px;" >
              <!-- Title & Settings -->
              <div class="d-flex justify-content-between align-items-center">
                <h4 class="h4 mb-0">Today</h4>
              </div>
              <!-- End Title & Settings -->
              ...
              <div class="row">
                <div class="col-1">
                  ...
                  <div class="text-center">
                    <h4 class="small mb-0">9:00 AM</h4>
                  </div>
                </div>
                <div class="col-1">
                  <div class="js-vr-progress progress-vertical rounded mb-2">
                  ...
                  <div class="text-center">
                    <h4 class="small mb-0">10:00 AM</h4>
                  </div>
                </div>
                <div class="col-1">
                  <div class="js-vr-progress progress-vertical rounded mb-2">
                  ...
                  <div class="text-center">
                    <h4 class="small mb-0">11:00 AM</h4>
                  </div>
                </div>
                <div class="col-1">
                  <div class="js-vr-progress progress-vertical rounded mb-2">
                  ...
                  <div class="text-center">
                    <h4 class="small mb-0">12:00 PM</h4>
                  </div>
                </div>
                <div class="col-1">
                  <div class="js-vr-progress progress-vertical rounded mb-2">
                  ...
                  <div class="text-center">
                    <h4 class="small mb-0">13:00 PM</h4>
                  </div>
                </div>
                <div class="col-1">
                  <div class="js-vr-progress progress-vertical rounded mb-2">
                  ...
                  <div class="text-center">
                    <h4 class="small mb-0">14:00 PM</h4>
                  </div>
                </div>
                <div class="col-1">
                  <div class="js-vr-progress progress-vertical rounded mb-2">
                  ...
                  <div class="text-center">
                    <h4 class="small mb-0">15:00 PM</h4>
                  </div>
                </div>
                <div class="col-1">
                  <div class="js-vr-progress progress-vertical rounded mb-2">
                  ...
                  <div class="text-center">
                    <h4 class="small mb-0">16:00 PM</h4>
                  </div>
                </div>
                <div class="col-1">
                  <div class="js-vr-progress progress-vertical rounded mb-2">
                  ...
                  <div class="text-center">
                    <h4 class="small mb-0">17:00 PM</h4>
                  </div>
                </div>
                <div class="col-1">
                  <div class="js-vr-progress progress-vertical rounded mb-2">
                  ...
                  <div class="text-center">
                    <h4 class="small mb-0">18:00 PM</h4>
                  </div>
                </div>
                <div class="col-1">
                  <div class="js-vr-progress progress-vertical rounded mb-2">
                  ...
                  <div class="text-center">
                    <h4 class="small mb-0">19:00 PM</h4>
                  </div>
                </div>
              </div>
              <!-- End Balance Info -->
