    ...
    <div class="container space-2">
      <div class="w-lg-75 mx-lg-auto">
        ...
        <div class="text-center mb-9">
          <h1 class="h2 font-weight-medium">주차요금 수정</h1>
          <p class="mb-0">reg_parking</p>
          <p>Submissions which exceed maximum word counts will be edited.</p>
        </div>
        <!-- End Title -->
		
        <form id="uppricepro" class="js-validate svg-preloader" method="post" action="uppricepro">
         ...
         <input type="hidden" name="bp_seq" value="${bp_seq}">
          ...
          <div class="mb-7">
            ...
            <div class="border-bottom pb-3 mb-5">
              <h2 class="h6 text-secondary mb-0">주차요금 수정</h2>
            </div>
            <!-- End Title -->
                  ...
                  <div class="js-focus-state">
                    ...
                    <div class="input-group">
                      <div class="input-group-prepend">
                		...
                		<input type="text" class="form-control" name="b_code" id="listingCityProvince" value="${b_code}" aria-label="City, Province" aria-describedby="listingCityProvinceLabel">
                    </div>
                  </div>
                </div>
                <!-- End Input -->
                  ...
                  <div class="js-focus-state">
                    ...
                    <div class="input-group">
                      <div class="input-group-prepend">
                		...
                		<input type="text" class="form-control" value="${pb_time}" name="pb_time" id="listingCityProvince" placeholder="pb_time" aria-label="City, Province" aria-describedby="listingCityProvinceLabel">
                    </div>
                  </div>
                </div>
                <!-- End Input -->
                ...
                <div class="form-group">
                  <div class="js-focus-state">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="pb_price" value="${pb_price}" id="listingCityProvince" placeholder="pb_price" aria-label="City, Province" aria-describedby="listingCityProvinceLabel">
                    </div>
                  </div>
                </div>
                <!-- End Input -->
                  ...
                  <div class="js-focus-state">
                    ...
                    <div class="input-group">
                      <div class="input-group-prepend">
                		...
                		<input type="text" class="form-control" name="pb_free" value="${pb_free}" id="listingCityProvince" placeholder="pb_free" aria-label="City, Province" aria-describedby="listingCityProvinceLabel">
                    </div>
                  </div>
                </div>
                <!-- End Input -->
                ...
                <div class="form-group">
                  <div class="js-focus-state">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="pb_free_price" value="${pb_free_price}" id="listingCityProvince" placeholder="pb_free_price" aria-label="City, Province" aria-describedby="listingCityProvinceLabel">
                    </div>
                  </div>
                </div>
                <!-- End Input -->
